...
import { BookOpen, Users, FileText, BarChart3, Settings, Home, Menu, X } from "lucide-react"
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center px-6 py-4 border-b border-sidebar-border">
            ...
            <h1 className="ml-3 text-xl font-serif font-bold text-sidebar-foreground">Boookverse</h1>
          </div>
